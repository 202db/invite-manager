module.exports = {
    ...
    welcomeChannel: "ID", // L'id du salon de bienvenue
    ...
    botstatus: {
        ...
        activity_text: "CustomPresence", // Le texte sur l'activiter du bot
        activity_url: "URL" // URL d'un de votre twitch ou youtube
    },
    inviteRewards: true, // Active ou pas les récompenses d'invitation sur le serveur
    rewards: [
        {
            invitesNeeded: 5, // Nombre d'inviations réquise
            roleID: "RoleID" // ID du rôle récompenses
